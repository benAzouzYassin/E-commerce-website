...
export default function AddProduct(props: ProductType) {
    ...
    return <div>
        <div className="flex items-center  gap-4 h-12 mt-10 ">
            <span className="h-full  justify-self-start mt-2 text-2xl font-semibold ">Quantity:</span>
            <div className="border mx-auto -translate-x-2 lg:-translate-x-5  border-black flex h-12 text-xl font-bold text-center  w-36 ">
        ...
        <div className="flex gap-4 mt-16 items-center justify-center w-full">
            ...
            }} className="hover:bg-[#72162d] text-xl bg-[#B6002C] transition-colors ease-in duration-20    text-white w-1/2 lg:px-9 px-6 py-2 font-semibold ">Buy now</button>
        </div>
