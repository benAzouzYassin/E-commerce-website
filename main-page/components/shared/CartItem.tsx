...
export default function CartItem(props: CartItemType) {
    ...
    return (
        <>
            <div className="flex h-28 translate-x-[5%] shadow-sm shadow-black/10 border w-[90%]  rounded-md  p-2">
                <img
                    src={props.imgLink}
                ...
                <div className="flex flex-col ml-2">
                    <p className="font-semibold text-sm  line-clamp-1 ">{props.name}</p>
                    <p className=" font-bold pt-5 ">{props.price * props.cartQuantity}$</p>
                    <div className="text-sm mb-2 mt-auto">
