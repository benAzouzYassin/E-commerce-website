...
//TODO  finish the order page
//TODO make the website responsive
//TODO fix some bug in the dashboard 
...
export default async function Page({ params }: { params: { id: string } }) {
    try {
        ...
        return <div className=" mb-16 px-72 min-h-[100vh] bg-white  w-full">
            <div className="flex mt-10 shadow-md h-[60vh] w-full ">
                <ProductImage additionalImages={product.additionalImages} imgLink={product.imgLink} name={product.name} />
                <div className="border-l-4 w-1/2 border-black/40 px-16 py-24  bg-black/5">
            ...
            <h2 className="text-3xl font-bold drop-shadow-sm mt-14">People Also Viewed</h2>
